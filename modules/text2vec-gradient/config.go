...
func (m *GradientModule) ClassConfigDefaults() map[string]interface{} {
	return map[string]interface{}{
		"vectorizeClassName": config.DefaultVectorizeClassName,
	}
}

func (m *GradientModule) PropertyConfigDefaults(
	dt *schema.DataType,
...
func (m *GradientModule) ValidateClass(ctx context.Context,
