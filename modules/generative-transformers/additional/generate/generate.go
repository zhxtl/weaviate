...
type generativetransformersClient interface {
...
type GenerateProvider struct {
	client                    generativetransformersClient
	maximumNumberOfGoroutines int
}

func New(generativetransformers generativetransformersClient) *GenerateProvider {
	return &GenerateProvider{generativetransformers, maximumNumberOfGoroutines}
}
