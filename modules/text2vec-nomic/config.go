...
func (m *NomicModule) ClassConfigDefaults() map[string]interface{} {
	return map[string]interface{}{
		"vectorizeClassName": vectorizer.DefaultVectorizeClassName,
		"baseURL":            vectorizer.DefaultBaseURL,
		"model":              vectorizer.DefaultNomicModel,
	}
}

func (m *NomicModule) PropertyConfigDefaults(
	dt *schema.DataType,
...
func (m *NomicModule) ValidateClass(ctx context.Context,
...
// 	// In text2vec-nomic (as opposed to e.g. text2vec-contextionary) the
...
// 	cv.logger.WithField("module", "text2vec-nomic").
// 		WithField("class", class.Class).
// 		Warnf("text2vec-nomic: Class %q does not have any properties "+
